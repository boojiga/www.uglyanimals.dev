				...
				<section id="feature-slider">
					<div class="wrapper">
						<div class="cycle-slideshow" 
						    ...
						    data-cycle-fx="'. $options['featured_slider_transition_effect'] .'"
							data-cycle-speed="'. $options['featured_slider_transition_length'] * 1000 .'"
							data-cycle-timeout="'. $options['featured_slider_transition_delay'] * 1000 .'"
		...
		while ( $get_featured_posts->have_posts()) : $get_featured_posts->the_post(); $i++;
			...
			<article class="'.$classes.'">
				...
				if ( has_post_thumbnail() ) {
					$clean_box_page_slider .= '<a title="' . the_title_attribute( array( 'before' => __( 'Permalink to:', 'clean-box' ), 'echo' => false ) ) . '" href="' . get_permalink() . '">
				...
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
							<a title="' . the_title_attribute( array( 'before' => __( 'Permalink to:', 'clean-box' ), 'echo' => false ) ) . '" href="' . get_permalink() . '">'.the_title( '<span>','</span>', false ).'</a>
						</h1>
