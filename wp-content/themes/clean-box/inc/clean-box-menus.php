...
if ( ! function_exists( 'clean_box_add_page_menu_class' ) ) :
/**
 * Filters wp_page_menu to add menu class  for default page menu
 *
 */
function clean_box_add_page_menu_class( $ulclass ) {
  return preg_replace( '/<ul>/', '<ul class="menu clean-box-nav-menu">', $ulclass, 1 );
}
endif; //clean_box_add_page_menu_class
add_filter( 'wp_page_menu', 'clean_box_add_page_menu_class' );
