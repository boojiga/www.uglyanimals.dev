...
function catchadaptive_customize_scripts() {
	...
	$catchadaptive_misc_links = array(
							'upgrade_link' 				=> esc_url( 'http://catchthemes.com/themes/catch-adaptive-pro/' ),
...
require get_template_directory() . '/inc/customizer-includes/catchadaptive-customizer-active-callbacks.php';


//Sanitize functions for customizer
require get_template_directory() . '/inc/customizer-includes/catchadaptive-customizer-sanitize-functions.php';